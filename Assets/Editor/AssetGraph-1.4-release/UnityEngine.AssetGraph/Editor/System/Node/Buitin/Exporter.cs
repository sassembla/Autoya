...
namespace UnityEngine.AssetGraph
{
    ...
    public class Exporter : Node, Model.NodeDataImporter
    {
            ...
            Action<Model.NodeData, string, float> progressFunc)
        {
            ...
            var cacheFolderDepth = Model.Settings.Path.BundleBuilderCachePath.Split(Model.Settings.UNITY_FOLDER_SEPARATOR).Length + 1;// quickfix, In Unity2018, this will fix Export problem
