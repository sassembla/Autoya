...
namespace AutoyaFramework.Information {
    ...
    public class ViewGenerator {
		...
		public GameObject GenerateViewFromSource (string source, ViewBox view, Action<double> progress, Action loadDone) {
			...
			GenerateView(rootObj, source, view, progress, loadDone);
			return rootObj;
		}
		

        private void GenerateView (GameObject rootObj, string source, ViewBox view, Action<double> progress, Action loadDone) {
