...
namespace AutoyaFramework {
	public partial class Autoya {
		...
		*/
		public static void Info_Show (string url, float windowWidth, float windowHeight, float anchorPos, Action<GameObject> viewAct, Action<double> progress, Action loadDone, Action<int, string> loadFailed) {
