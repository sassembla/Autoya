...
namespace AutoyaFramework {
	public partial class Autoya {
		...
		*/
		public static void Info_Show (string url, string viewName, float windowWidth, float windowHeight, float anchorPos, Action<GameObject> onRootViewGenerated, Action<Rect> layoutDone, Action<double> viewDownloadProgress, Action loadDone, Action<int, string> loadFailed) {
