...
namespace AutoyaFramework {
	public partial class Autoya {
		...
		*/
		public static void Info_Show (string url, string viewName, float windowWidth, float windowHeight, float anchorPos, Action<GameObject> onRootViewLoaded, Action<double> progress, Action loadDone, Action<int, string> loadFailed) {
